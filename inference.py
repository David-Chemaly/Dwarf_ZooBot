...
# Load the Data
SEED = 42
DATA_PATH = '/Volumes/ES-HDD-Documents/Documents/matlas_dwarfs/NGC4249_224_patches_NO-Overlap.h5'
...
X, y = np.arange(0, N, 1), patches_binary

X_train, X_test, y_train, y_test = train_test_split(X, y, test_size=0.2, stratify=y, random_state=SEED)

arg_valid = np.sort(X_test)
np.savetxt(f'arg_valid_seed{SEED}_stratify.txt', arg_valid)
...
np.savetxt('arg_interesting_NO-Overlap.txt', arg_interesting)
print('Done!')